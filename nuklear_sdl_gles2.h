...
NK_API void                 nk_sdl_gles2_font_stash_end(void);
NK_API int                  nk_sdl_gles2_handle_event(SDL_Event *evt);
NK_API void                 nk_sdl_gles2_render(enum nk_anti_aliasing , int max_vertex_buffer, int max_element_buffer, int vflip);
NK_API void                 nk_sdl_gles2_shutdown(void);
NK_API void                 nk_sdl_gles2_device_destroy(void);
NK_API void                 nk_sdl_gles2_device_create(void);
NK_API void                 nk_sdl_gles2_handle_grab(void);
...
NK_API void
nk_sdl_gles2_device_create(void)
{
    GLint status;
...
NK_API void
nk_sdl_gles2_device_destroy(void)
{
    struct nk_sdl_device *dev = &sdl.ogl;
...
NK_API void
nk_sdl_gles2_render(enum nk_anti_aliasing AA, int max_vertex_buffer, int max_element_buffer, int vflip)
{
    struct nk_sdl_device *dev = &sdl.ogl;
...
nk_sdl_gles2_init(SDL_Window *win)
{
    sdl.win = win;
...
NK_API void
nk_sdl_gles2_font_stash_begin(struct nk_font_atlas **atlas)
{
...
NK_API void
nk_sdl_gles2_font_stash_end(void)
{
...
NK_API int
nk_sdl_gles2_handle_event(SDL_Event *evt)
{
    struct nk_context *ctx = &sdl.ctx;
...
NK_API
void nk_sdl_gles2_shutdown(void)
{
    nk_font_atlas_clear(&sdl.atlas);
    nk_free(&sdl.ctx);
    nk_sdl_gles2_device_destroy();
