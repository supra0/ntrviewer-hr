...
struct CommonSharedConstants {
	...
	static constexpr const char* LOG_PATH = "magpie-logs\\magpie.log";
	...
	static constexpr const wchar_t* SOURCES_DIR = L"magpie-sources\\";
	static constexpr const wchar_t* EFFECTS_DIR = L"magpie-effects\\";
	static constexpr const wchar_t* ASSETS_DIR = L"assets\\";
	static constexpr const wchar_t* CACHE_DIR = L"magpie-cache\\";
